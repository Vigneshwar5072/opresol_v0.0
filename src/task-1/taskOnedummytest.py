...
# execute a statement
    ...
    cur.execute("CREATE SCHEMA fifa_temp;")
    conn.commit()
    print("schema created")
    return("schema created successfully")

def create_table(cur, conn):
    cur.execute("""CREATE TABLE IF NOT EXISTS fifa_temp.player_twenty_temp(sofifa_id INT NOT NULL PRIMARY KEY,  
    ...
    conn.commit()
    cur.execute("SELECT * FROM fifa_temp.player_twenty_temp")
    print("player_twenty_temp table created")
