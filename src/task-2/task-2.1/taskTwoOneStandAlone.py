...
def UserInput():
    #read the user defined input from the key pad
...
def skillset():
    ...
    #read all the skillset from the data into the array
    ...
    #calling the userInput function to read how many top performers required in each skill
    min_capacity = UserInput()

    #check for the user input issues
...
print(top_performed_improvement)
